...
<section class="${"tools md:text-xl md:text-justify md:tracking-wide bg-red-900 w-full flex justify-center relative p-8 svelte-oj6189"}">${validate_component(Tuner, "Tuner").$$render($$result, {}, {}, {})}</section>
